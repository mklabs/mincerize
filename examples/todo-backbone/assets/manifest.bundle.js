...
(function(definition) {
    ...
    if ([ 1, 2 ].splice(0).length != 2) {
        ...
        Array.prototype.splice = function(start, deleteCount) {
            if (!arguments.length) return []; else return array_splice.apply(this, [ start === void 0 ? 0 : start, deleteCount === void 0 ? this.length - start : deleteCount ].concat(slice.call(arguments, 2)));
        };
    }
    ...
    if (!Array.prototype.forEach) Array.prototype.forEach = function forEach(fun) {
        ...
        if (_toString(fun) != "[object Function]") throw new TypeError();
    ...
    if (!Array.prototype.lastIndexOf || [ 0, 1 ].lastIndexOf(0, -3) != -1) Array.prototype.lastIndexOf = function lastIndexOf(sought) {
        var self = splitString && _toString(this) == "[object String]" ? this.split("") : toObject(this), length = self.length >>> 0;
        if (!length) return -1;
        var i = length - 1;
...
crElNS = "createElementNS" in document ? document.createElementNS : function(m, n) {
    return document.createElement(n);
};

/*! outerHTML - https://gist.github.com/1044128 */
"undefined" !== typeof document && !("outerHTML" in crElNS("http://www.w3.org/1999/xhtml", "_")) && function(a) {
    var c = crElNS("http://www.w3.org/1999/xhtml", "_"), a = (a.HTMLElement || a.Element).prototype, e = new XMLSerializer(), b = function() {
        var a;
        if (document.xmlVersion) return e.serializeToString(this);
        c.appendChild(this.cloneNode(!1));
        a = c.innerHTML.replace("><", ">" + this.innerHTML + "<");
        c.innerHTML = "";
        return a;
    }, d = function(a) {
        var b = this.parentNode;
        if (null === b) throw DOMException.code = DOMException.NOT_FOUND_ERR, DOMException;
        for (c.innerHTML = a; a = c.firstChild; ) b.insertBefore(a, this);
        b.removeChild(this);
    };
    if (Object.defineProperty) {
        ...
        try {
            Object.defineProperty(a, "outerHTML", b);
        } catch (f) {
            -2146823252 === f.number && (b.enumerable = !1, Object.defineProperty(a, "outerHTML", b));
        }
    } else Object.prototype.__defineGetter__ && Object.prototype.__defineSetter__ && (a.__defineGetter__("outerHTML", b), 
    a.__defineSetter__("outerHTML", d));
}(self);
...
(function(e, t) {
    ...
    function a(e, t, n) {
        function r() {
            var u = arguments, a = s ? this : t;
            return i || (e = t[o]), n.length && (u = u.length ? n.concat(nt.call(u)) : n), this instanceof r ? (p.prototype = e.prototype, 
            a = new p(), (u = e.apply(a, u)) && Ht[typeof u] ? u : a) : e.apply(a, u);
        }
        var i = m(e), s = !n, o = e;
        return s && (n = t), r;
    }
    ...
    function l() {
        ...
        }, t, i = -1; t = arguments[++i]; ) for (var s in t) {
            var o = t[s];
            /d|h/.test(s) ? ("string" == typeof o && (o = {
                b: o,
                k: o
            }), e.c[s] = o.b, e.l[s] = o.k) : e[s] = o;
        }
        t = e.a;
        if ("d" != (e.f = /^[^,]+/.exec(t)[0]) || !e.c.h) e.c = r;
        i = "", e.r && (i += "'use strict';"), i += "var i,A,j=" + e.f + ",t=" + (e.i || e.f) + ";if(!" + e.f + ")return t;" + e.p + ";", 
        e.c && (i += "var k=j.length;i=-1;", e.l && (i += "if(k===+k){"), e.n && (i += "if(y.call(j)==w){j=j.split('')}"), 
        i += e.c.d + ";while(++i<k){A=j[i];" + e.c.h + "}", e.l && (i += "}"));
        if (e.l) {
            e.c ? i += "else {" : e.m && (i += "var k=j.length;i=-1;if(k&&O(j)){while(++i<k){A=j[i+=''];" + e.l.h + "}}else {"), 
            e.g || (i += "var u=typeof j=='function'&&q.call(j,'prototype');");
            if (e.j && e.q) i += "var n=-1,o=Y[typeof j]?l(j):[],k=o.length;" + e.l.d + ";while(++n<k){i=o[n];", 
            e.g || (i += "if(!(u&&i=='prototype')){"), i += "A=j[i];" + e.l.h + "", e.g || (i += "}"); else {
                i += e.l.d + ";for(i in j){";
                if (!e.g || e.q) i += "if(", e.g || (i += "!(u&&i=='prototype')"), !e.g && e.q && (i += "&&"), 
                e.q && (i += "h.call(j,i)"), i += "){";
                i += "A=j[i];" + e.l.h + ";";
                if (!e.g || e.q) i += "}";
            }
            ...
            if (e.g) {
                ...
                for (s = 0; 7 > s; s++) i += "i='" + e.o[s] + "';if(", "constructor" == e.o[s] && (i += "!(g&&g.prototype===j)&&"), 
                i += "h.call(j,i)){A=j[i];" + e.l.h + "}";
            }
            if (e.c || e.m) i += "}";
        }
    ...
    function g(e) {
        ...
        var n = e.constructor;
        return (!Lt || "function" == typeof e.toString || "string" != typeof (e + "")) && (!m(n) || n instanceof n) ? xt ? (en(e, function(e, n, r) {
    ...
    function b(e, t, s, o) {
        ...
        var a = Dt[u];
        if (Nt && !a && (a = v(e)) && !v(t) || !a && (u != mt || Lt && ("function" != typeof e.toString && "string" == typeof (e + "") || "function" != typeof t.toString && "string" == typeof (t + "")))) return i;
        s || (s = []), o || (o = []);
        ...
        if (Et) for (;7 > ++u; ) if (c = J[u], Z.call(e, c) && (!Z.call(t, c) || !b(e[c], t[c], s, o))) return i;
        return n;
    }
    function w(e, t, n) {
    ...
    function T(e, t, n) {
        ...
        if ("number" == typeof n) r = (0 > n ? at(0, i + n) : n || 0) - 1; else if (n) return r = C(e, t), 
        e[r] === t ? r : -1;
    ...
    function C(e, t, n, r) {
        ...
        } else for (;i < s; ) r = i + s >>> 1, e[r] < t ? i = r + 1 : s = r;
        return i;
    }
    function k(e, t, n, r) {
        var s = -1, o = e ? e.length : 0, u = [], a = [];
        "function" == typeof t && (r = n, n = t, t = i);
        for (n = f(n, r); ++s < o; ) if (r = n(e[s], s, e), t ? !s || a[a.length - 1] !== r : 0 > T(a, r)) a.push(r), 
        u.push(e[s]);
        return u;
    }
    function L(e, t) {
    ...
    function O(e) {
        mn(nn(e), function(t) {
            ...
            s.prototype[t] = function() {
                ...
                return arguments.length && et.apply(e, arguments), e = r.apply(s, e), this.__chain__ && (e = new s(e), 
                e.__chain__ = n), e;
            };
        });
    }
    var n = !0, r = null, i = !1, M = "object" == typeof exports && exports && ("object" == typeof global && global && global == global.global && (e = global), 
    exports), _ = Array.prototype, D = Object.prototype, P = 0, H = 30, B = e._, j = /[-?+=!~*%&^<>|{(\/]|\[\D|\b(?:delete|in|instanceof|new|typeof|void)\b/, F = /&(?:amp|lt|gt|quot|#x27);/g, I = /\b__p\+='';/g, q = /\b(__p\+=)''\+/g, R = /(__e\(.*?\)|\b__t\))\+'';/g, U = /\w*$/, z = /(?:__e|__t=)\(\s*(?![\d\s"']|this\.)/g, W = RegExp("^" + (D.valueOf + "").replace(/[.*+?^=!:${}()|[\]\/\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$"), X = /($^)/, V = /[&<>"']/g, $ = /['\n\r\t\u2028\u2029\\]/g, J = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" "), K = Math.ceil, Q = _.concat, G = Math.floor, Y = W.test(Y = Object.getPrototypeOf) && Y, Z = D.hasOwnProperty, et = _.push, tt = D.propertyIsEnumerable, nt = _.slice, rt = D.toString, it = W.test(it = nt.bind) && it, st = W.test(st = Array.isArray) && st, ot = e.isFinite, ut = W.test(ut = Object.keys) && ut, at = Math.max, ft = Math.min, lt = Math.random, ct = "[object Arguments]", ht = "[object Array]", pt = "[object Boolean]", dt = "[object Date]", vt = "[object Number]", mt = "[object Object]", gt = "[object RegExp]", yt = "[object String]", bt = e.clearTimeout, wt = e.setTimeout, Et, St, xt, Tt = n;
    (function() {
        function e() {
            this.x = 1;
        }
    ...
    var Nt = !v(arguments), Ct = "x" != nt.call("x")[0], kt = "xx" != "x"[0] + Object("x")[0];
    try {
    ...
    var jt = {
        a: "d,c,x",
        p: "c=f(c,x)",
        h: "if(c(A,i,d)===false)return t"
    }, Ft = {
        i: "{}",
        p: "c=f(c,x)",
        h: "var p=c(A,i,d);(h.call(t,p)?t[p]++:t[p]=1)"
    }, It = {
        i: "true",
        h: "if(!c(A,i,d))return!t"
    }, qt = {
        q: i,
        r: i,
        a: "m",
        p: "for(var a=1,b=arguments.length;a<b;a++){if(j=arguments[a]){",
        h: "t[i]=A",
        e: "}}"
    }, Rt = {
        i: "[]",
        ...
        h: {
            b: "t[i]=c(A,i,d)",
            k: "t" + (Mt ? "[n]=" : ".push") + "(c(A,i,d))"
        }
    }, Xt = {
        q: i,
        a: "m,c,x",
        i: "{}",
        p: "var R=typeof c=='function';if(R)c=f(c,x);else var s=e.apply(E,arguments)",
        h: "if(R?!c(A,i,m):M(s,i)<0)t[i]=A"
    }, Vt = l({
        a: "m",
        i: "{}",
        h: "t[A]=i"
    ...
    var Jt = Y ? function(e) {
        ...
        a: "A",
        i: "true",
        p: "var H=y.call(A),k=A.length;if(D[H]" + (Nt ? "||O(A)" : "") + "||(H==X&&k===+k&&S(A.splice)))return!k",
        h: {
            k: "return false"
        }
    }), sn = ut ? function(e) {
        ...
        a: "m,dd,N",
        p: "var P,C=arguments,a=0;if(N==I){var b=2,ee=C[3],ff=C[4]}else var b=C.length,ee=[],ff=[];while(++a<b){if(j=C[a]){",
        h: "if((dd=A)&&((P=Q(dd))||T(dd))){var K=false,gg=ee.length;while(gg--)if(K=ee[gg]==dd)break;if(K){t[i]=ff[gg]}else {ee.push(dd);ff.push(A=(A=t[i],P)?(Q(A)?A:[]):(T(A)?A:{}));t[i]=G(A,dd,I,ee,ff)}}else if(dd!=null)t[i]=dd"
    }), un = l(Xt), an = l({
        a: "m",
        i: "[]",
        h: "t" + (Mt ? "[n]=" : ".push") + "([i,A])"
    }), fn = l(Xt, {
        p: "if(typeof c!='function'){var i=0,s=e.apply(E,arguments),k=s.length;while(++i<k){var p=s[i];if(p in m)t[p]=m[p]}}else {c=f(c,x)",
        h: "if(c(A,i,m))t[i]=A",
        e: "}"
    }), ln = l({
        a: "m",
        ...
        n: i,
        d: {
            b: "if(y.call(d)==w)return d.indexOf(hh)>-1"
        },
        h: "if(A===hh)return true"
    }), hn = l(jt, Ft), pn = l(jt, It), dn = l(jt, Rt), vn = l(jt, Ut, {
        i: "z",
        h: "if(c(A,i,d))return A"
    }), mn = l(jt, Ut), gn = l(jt, Ft, {
        h: "var p=c(A,i,d);(h.call(t,p)?t[p]:t[p]=[]).push(A)"
    }), yn = l(Wt, {
        a: "d,U",
        p: "var C=v.call(arguments,2),R=typeof U=='function'",
        h: {
            b: "t[i]=(R?U:A[U]).apply(A,C)",
            k: "t" + (Mt ? "[n]=" : ".push") + "((R?U:A[U]).apply(A,C))"
        }
    }), bn = l(jt, Wt), wn = l(Wt, {
        a: "d,bb",
        h: {
        ...
        a: "d,c,B,x",
        i: "B",
        p: "var V=arguments.length<3;c=f(c,x)",
        d: {
            b: "if(V)t=j[++i]"
        },
        h: {
            b: "t=c(t,A,i,d)",
            k: "t=V?(V=false,A):c(t,A,i,d)"
        }
    }), Sn = l(jt, Rt, {
        h: "!" + Rt.h
    }), xn = l(jt, It, {
        ...
        h: {
            b: "t[i]={a:c(A,i,d),b:i,c:A}",
            k: "t" + (Mt ? "[n]=" : ".push") + "({a:c(A,i,d),b:i,c:A})"
        },
        e: "t.sort(I);k=t.length;while(k--)t[k]=t[k].c"
    }), Nn = l(Rt, {
        a: "d,aa",
        p: "var s=[];J(aa,function(A,p){s.push(p)});var cc=s.length",
        h: "for(var Z=true,r=0;r<cc;r++){var p=s[r];if(!(Z=A[p]===aa[p]))break}Z&&t.push(A)"
    }), Cn = l({
        q: i,
        r: i,
        a: "m",
        p: "var L=arguments,i=0,k=L.length;if(k>1){while(++i<k)t[L[i]]=F(t[L[i]],t);return t}",
        h: "if(S(A))t[i]=F(A,t)"
    });
    ...
    }, s.bind = L, s.bindAll = Cn, s.chain = function(e) {
    ...
    }, s.defaults = Yt, s.defer = function(e) {
    ...
    }, s.every = pn, s.extend = Zt, s.filter = dn, s.find = vn, s.first = S, s.flatten = x, 
    s.forEach = mn, s.forIn = en, s.forOwn = tn, s.functions = nn, s.groupBy = gn, s.has = function(e, t) {
        ...
        return e === t;
    }, s.keys = sn, s.last = function(e, t, n) {
        if (e) {
            var i = e.length;
    ...
    }, s.pick = fn, s.pluck = wn, s.random = function(e, t) {
        ...
        e.replace(RegExp((n.escape || u.escape || X).source + "|" + (n.interpolate || u.interpolate || X).source + "|" + (n.evaluate || u.evaluate || X).source + "|$", "g"), function(t, n, i, s, u) {
            a += e.slice(o, u).replace($, c), a += n ? "'+__e(" + n + ")+'" : s ? "';" + s + ";__p+='" : i ? "'+((__t=(" + i + "))==null?'':__t)+'" : "", 
            r || (r = s || j.test(n || i)), o = u + t.length;
        }), a += "';", l || (f = "obj", r ? a = "with(" + f + "){" + a + "}" : (n = RegExp("(\\(\\s*)" + f + "\\." + f + "\\b", "g"), 
        a = a.replace(z, "$&" + f + ".").replace(n, "$1__d"))), a = (r ? a.replace(I, "") : a).replace(q, "$1").replace(R, "$1;"), 
        a = "function(" + f + "){" + (l ? "" : f + "||(" + f + "={});") + "var __t,__p='',__e=_.escape" + (r ? ",__j=Array.prototype.join;function print(){__p+=__j.call(arguments,'')}" : (l ? "" : ",__d=" + f + "." + f + "||" + f) + ";") + a + "return __p}";
        try {
        ...
        return function() {
            ...
            return i = arguments, o = this, 0 >= f ? (bt(u), a = r, s = e.apply(o, i)) : u || (u = wt(n, f)), 
            s;
        };
        ...
        for (var t = -1, n = e ? w(wn(arguments, "length")) : 0, r = Array(n); ++t < n; ) r[t] = wn(arguments, t);
        return r;
    }, s.all = pn, s.any = xn, s.collect = bn, s.detect = vn, s.drop = N, s.each = mn, 
    s.foldl = En, s.foldr = E, s.head = S, s.include = cn, s.inject = En, s.methods = nn, 
    s.select = dn, s.tail = N, s.take = S, s.unique = k, O(s), s.prototype.chain = function() {
        ...
        s.prototype[e] = function() {
            var e = this.__wrapped__;
            return t.apply(e, arguments), St && e.length === 0 && delete e[0], this.__chain__ && (e = new s(e), 
            e.__chain__ = n), e;
        };
    ...
    }), typeof define == "function" && typeof define.amd == "object" && define.amd ? (e._ = s, 
    define(function() {
        return s;
...
(function() {
    ...
    var p = /\s+/, k = g.Events = {
        ...
        off: function(a, b, c) {
            ...
            if (e = this._callbacks) {
                ...
                h && (b || c)) for (g = h.tail; (h = h.next) !== g; ) if (j = h.callback, q = h.context, 
    ...
    f.extend(o.prototype, k, {
        ...
        set: function(a, b, c) {
            ...
            for (e in d) {
                ...
                !f.isEqual(j[e], a) || f.has(h, e) != f.has(j, e) ? (this.changed[e] = a, c.silent || (this._pending[e] = !0)) : (delete this.changed[e], 
    ...
    f.extend(r.prototype, k, {
        ...
        add: function(a, b) {
            ...
            c = 0;
            for (d = a.length; c < d; c++) (e = a[c]).on("all", this._onModelEvent, this), this._byCid[e.cid] = e, 
